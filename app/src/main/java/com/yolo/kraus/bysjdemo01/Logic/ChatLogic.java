...
import com.yolo.kraus.bysjdemo01.event.RefreshEvent;
 ...
 * 聊天界面逻辑
 */
public class ChatLogic implements Observer {
    ...
    public ChatLogic(ChatView view, String identify, TIMConversationType type){
        this.view = view;
