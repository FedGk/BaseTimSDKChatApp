...
import com.yolo.kraus.bysjdemo01.BuildConfig;
import com.yolo.kraus.bysjdemo01.Model.FileMessage;
...
import com.yolo.kraus.bysjdemo01.Util.MediaUtil;
import com.yolo.kraus.bysjdemo01.Util.RecorderUtil;
import com.yolo.kraus.bysjdemo01.viewfeatures.ChatView;
import com.yolo.kraus.ui.TemplateTitle;
import com.yolo.kraus.ui.VoiceSendingView;
...
public class ChatActivity extends FragmentActivity implements ChatView{
    ...
    private static final int PERMISSION_GROUPSTORAGE = 600;
    private Uri fileUri;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(identify.isEmpty())
        {
            identify = nowInfo.getInstance().getId();
        }
        type = (TIMConversationType) getIntent().getSerializableExtra("type");
        presenter = new ChatLogic(this, identify, type);
...
//        RefreshEvent.getInstance().onRefresh();
     ...
     * @param message 返回的消息
     *
     * {@link ChatView#showMessage(TIMMessage)} 关联与展示消息
     */
    @Override
    ...
    /**
     * send image file from this android device
     */
    @Override
...
//                Log.d(TAG, BuildConfig.APPLICATION_ID + ".fileprovider");
                ...
                {
                    fileUri = FileProvider.getUriForFile(getApplicationContext(), BuildConfig.APPLICATION_ID + ".fileprovider", tempFile);
     ...
     * 回调:视频聊天
     *
     * todo create TCVideoRecordActivity
     */
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            {
                showImagePreview(FileUtil.getFPUriToPath(this,fileUri));
            }
        }
...
//                    Intent intent_photo = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//                    intent_photo.putExtra(MediaStore.EXTRA_OUTPUT, fileUri);
//                    intent_photo.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
//                    startActivityForResult(intent_photo, CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE);
//                }
//                break;
//            default:
