...
import com.yolo.kraus.bysjdemo01.Logic.*;
 ...
 * 好友关系链管理逻辑
 */
public class FriendshipManagerLogic {
    ...
    public FriendshipManagerLogic(FriendshipMessageView view){
        this(view, null, null);
    }

    public FriendshipManagerLogic(FriendInfoView view){
        this(null, null, view);
    }

    public FriendshipManagerLogic(FriendshipManageView view){
        this(null, view, null);
    }

    public FriendshipManagerLogic(FriendshipMessageView view1, FriendshipManageView view2, FriendInfoView view3){
