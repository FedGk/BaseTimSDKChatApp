...
import com.yolo.kraus.bysjdemo01.viewfeatures.GroupManageView;
...
public class GroupManagerLogic {
    ...
    public GroupManagerLogic(GroupManageMessageView view){
        this(view, null, null);
    }

    public GroupManagerLogic(GroupInfoView view){
        infoView = view;
    }

    public GroupManagerLogic(GroupManageView view){
        this(null, null, view);
    }

    public GroupManagerLogic(GroupManageMessageView view1, GroupInfoView view2, GroupManageView view3){
        messageView = view1;
        infoView = view2;
        manageView = view3;
    }
