...
import com.yolo.kraus.bysjdemo01.Logic.GroupInfoLogic;
...
public class GroupProfileActivity extends FragmentActivity implements GroupInfoView, View.OnClickListener {
    ...
    private GroupInfoLogic GroupInfoLogic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GroupInfoLogic = new GroupInfoLogic(this, Collections.singletonList(identify), isInGroup);
        GroupInfoLogic.getGroupDetailInfo();
    ...
    public void showGroupInfo(List<TIMGroupDetailInfo> groupInfos) {
        ...
        isGroupOwner = info.getGroupOwner().equals(nowInfo.getInstance().getId());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnDel:
                if (isGroupOwner){
                    GroupManagerLogic.dismissGroup(identify, new TIMCallBack() {
                        @Override
                    ...
                    GroupManagerLogic.quitGroup(identify, new TIMCallBack() {
                        @Override
                        public void onError(int i, String s) {
                            Log.i(TAG, "onError code" + i + " msg " + s);
                        }
            ...
            case R.id.messageNotify:
                ...
                new ListPickerDialog().show(messageOptList,getSupportFragmentManager(), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, final int which) {
                        TIMGroupManagerExt.ModifyMemberInfoParam param = new TIMGroupManagerExt.ModifyMemberInfoParam(identify, nowInfo.getInstance().getId());
