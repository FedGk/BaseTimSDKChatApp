...
import com.yolo.kraus.bysjdemo01.MAdapter.GroupListAdapter;
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (groupname.equals("")) {
                    ...
                    FriendshipManagerLogic.createFriendGroup(groupname, new TIMValueCallBack<List<TIMFriendResult>>() {
                        @Override
    ...
    private void deleteDialog(final int position) {
        ...
        dialog.show(getString(R.string.delete_dialog_subtitle)+groups.get(position)+getString(R.string.delete_dialog_subtitle_sur), ManageFriendGroupActivity.this.getSupportFragmentManager(), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                FriendshipManagerLogic.delFriendGroup(groups.get(position), new TIMCallBack() {
                    @Override
                    public void onError(int i, String s) {
                        Log.e(TAG, "onError code " + i + " msg " + s);
